...
import os
import glob
import tensorflow_addons as tfa # modified: comment out
import random
...
class DataReader:
    ...
    def load_image(self, path):    
      ...
      mask_path = tf.strings.regex_replace(mask_path, "_oct_", "_mask_")  # modified: add this line
      ...
      mask = tf.cast(mask, tf.int32) // 85    # modified: add this line: map 0,85,170,255 to 0,1,2,3
